...
namespace MainMenu
{
    public sealed class MenuManager : MonoBehaviour
    {
        ...
        internal static AudioSource _playerSource { get; private set; }
        ...
        private void ChangeSoundVolume()
        {
            ...
            _playerSource.volume = AdvancedSettings.SoundVolume * 0.01f * 0.5f;
        }
        ...
        private void Awake()
        {
            ...
            _playerSource = GetComponents<AudioSource>()[1];
