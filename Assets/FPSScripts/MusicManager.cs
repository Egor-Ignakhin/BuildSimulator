...
namespace Settings
{
    sealed class MusicManager : MonoBehaviour
    {
        ...
        private void ChangeSkyBox()// смена скайбокса и положения солнца в зависимости от выбранной карты в настройках
        {
            ...
            if (type == 0)// desert
                FindObjectOfType<SunSettings>().transform.eulerAngles = new Vector3(30, -120, 0);
            else// mountains
                FindObjectOfType<SunSettings>().transform.eulerAngles = new Vector3(50, -150, 0);
        }
